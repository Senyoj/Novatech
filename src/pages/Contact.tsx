                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      We welcome guest contributions! Email us with your article
                      idea and writing samples.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-medium">
                      I found a bug or error in an article
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      Please let us know through the contact form, and we'll fix
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Yes, we have sponsorship and advertising options. Contact
